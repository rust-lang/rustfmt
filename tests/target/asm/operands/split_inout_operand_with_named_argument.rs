...
asm!(
    "instruction {}",
    name = inout(reg) in_expr => out_expr,
);
asm!(
    "instruction {}",
    name = inlateout(reg) in_expr => out_expr,
);
asm!(
    "instruction {}",
    name = inout(reg) in_expr => _,
);
asm!(
    "instruction {}",
    name = inlateout(reg) in_expr => _,
);
...
asm!(
    "instruction {}",
    some_long_name =
        inout(reg) in_expr => out_expr,
);
asm!(
    "instruction {}",
    some_long_name =
        inlateout(reg) in_expr => out_expr,
);
asm!(
    "instruction {}",
    some_very_long_name =
        inout(reg_abcd) in_expr => _,
);
asm!(
    "instruction {}",
    some_very_long_name =
        inlateout(reg_abcd) in_expr => _,
);
...
asm!(
    "instruction {}",
    some_long_name =
        inlateout(reg) very_long_expression
            => very_long_out_expression,
);
...
asm!(
    "instruction {}",
    some_long_name =
        inout(reg) very_very_very_long_expression
            => _,
);
asm!(
    "instruction {}",
    some_long_name =
        inlateout(reg) very_very_very_long_expression
            => _,
);
