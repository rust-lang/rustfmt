...
fn fn_with_everything_long<T, U, 'a>(
    aaaa: f64,
    bbbb: f64,
    cccc: f64,
    dddd: f64,
...
fn fn_with_long_return_type_and_body(
    a: f64,
) -> Result<
    HashMap<String, Vec<(SomeLongTypeName, AnotherLongTypeName, YetAnotherType)>>,
    Box<dyn Error + Send + Sync + 'static>,
...
fn fn_with_wrapping_return_type_and_body<T>(
    aaaaaa: f64,
    bbbbbb: T,
    ccc: f64,
    ddd: f64,
...
pub trait Trait {
    ...
    fn method_with_everything_long<T, U, 'a>(
        &self,
        aaaa: f64,
        bbbb: f64,
        cccc: f64,
    ...
    fn method_with_long_return_and_body(
        &self,
    ) -> Result<
        HashMap<String, Vec<(SomeLongTypeName, AnotherLongTypeName, YetAnotherType)>>,
        Box<dyn Error + Send + Sync + 'static>,
    ...
    fn method_with_wrapping_return_type_and_body<T>(
        aaaa: f64,
        bb: T,
        cc: f64,
        d: f64,
    ...
    fn method_with_long_return_and_where_and_body<T, U, 'a>(
        self,
    ) -> Result<
        HashMap<String, Vec<(SomeLongTypeName, AnotherLongTypeName, YetAnotherType)>>,
        Box<dyn Error + Send + Sync + 'static>,
    ...
    fn method_with_everything_long_and_body<T, U, 'a>(
        aaaa: f64,
        bbbb: f64,
        cccc: f64,
        dddd: f64,
